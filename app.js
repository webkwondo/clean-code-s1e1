...
var editTask=function(){
    ...
    var editBtn=listItem.querySelector('.' + editButtonClsName);
    var containsClass=listItem.classList.contains(editModeCls);
    ...
    listItem.classList.toggle(editModeCls);
};
...
//select ListItems children
    ...
    var editButton=taskListItem.querySelector('.' + editButtonClsName);
    var deleteButton=taskListItem.querySelector('.' + deleteButtonClsName);
